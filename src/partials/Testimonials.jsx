      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">Wer sind wir?</h2>
            <p className="text-xl text-gray-600" data-aos="zoom-y-out">
              Wir sind ehemalige AustauschschülerInnen, die in China in einer Gastfamilie gelebt haben 
              und sich auch in ihrer Freizeit mit China auseinandersetzen.
              <br />
          ...
          {/* Items */}
          <div className="max-w-sm md:max-w-1xl mx-auto grid gap-1 grid-cols-1 md:grid-cols-1 justify-center mb-20">

            {/* Item */}
            {/* <div className="flex items-center justify-center py-2 mx-5 col-span-2 md:col-auto">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/AFS_Interkulturelle_Begegnungen_Logo.svg/1280px-AFS_Interkulturelle_Begegnungen_Logo.svg.png">
              </img>
            </div> */}

            {/* Item */}
            <div className="flex items-center justify-center mx-5 col-span-2 md:col-auto">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Stiftung_Mercator_Logo.svg/2560px-Stiftung_Mercator_Logo.svg.png">
              </img>
            </div>
          ...
          {/* Testimonials */}
          <div className="max-w-3xl mx-auto mt-36" data-aos="zoom-y-out">
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                ...
                <blockquote className="text-xl font-medium mb-4">
                  “ Mein Auslandsjahr in China hat mir einen umfangreichen Einblick in das faszinierende Land ermöglicht.
                  <br />
                    Nun möchte ich durch diese Lauf-Challenge auch anderen die chinesische Kultur näherbringen. “
                </blockquote>
                <cite className="block font-bold text-lg not-italic mb-1">Tilman Herz</cite>
                <div className="text-gray-600">
                  <span>2019/20 in China</span>
