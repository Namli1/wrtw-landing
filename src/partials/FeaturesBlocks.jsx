...
function FeaturesBlocks() {
  return (
    <section className="relative theme-background">
      ...
      <div className="absolute left-0 right-0 bottom-0 m-auto w-px p-px h-20 bg-red-200 transform translate-y-1/2"></div> */}
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600">
              Was du alles während der einmonatigen Lauf-Challenge erleben kannst.
              </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
                  <rect className="fill-current text-brown-400" width="64" height="64" rx="32" />
                  <g strokeWidth="2">
              ...
              <p className="text-gray-600 text-center">
                Direkt von China-ExpertenInnen und AustauschschülernInnen erzählt!
                </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Spreche live mit ExpertenInnen über China.
                </p>
            </div>
